...
export default function CatalogGrid() {
  ...
  return (
    <section id="catalog" className="py-16 lg:py-32 bg-background px-6 overflow-hidden">
              ...
              >
                {displayedItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="transition-all duration-500 ease-out sm:top-full left-0 w-full bg-[#5a5a5a] z-0 rounded-b-2xl sm:opacity-0 sm:translate-y-[-16px] sm:group-hover/card:translate-y-0 sm:group-hover/card:opacity-100 opacity-100 translate-y-0 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.15)] pointer-events-none transform-gpu relative sm:absolute">
                      <div className="p-4 md:p-5 text-center bg-[#5a5a5a] relative rounded-b-2xl">
                        <p className="text-[8px] font-sans font-bold uppercase tracking-[0.3em] text-white/70 mb-2 sm:opacity-0 sm:group-hover/card:opacity-100 opacity-100 transition-opacity duration-500 delay-75 text-center">
                          {item.headline}
                        </p>
                        <div className="w-6 h-px bg-white/20 mx-auto mb-2 sm:scale-x-0 sm:group-hover/card:scale-x-100 scale-x-100 transition-transform duration-500 delay-100"></div>
                        <h3 className="text-sm sm:text-lg font-display font-medium text-white sm:opacity-0 sm:group-hover/card:opacity-100 opacity-100 transition-opacity duration-500 delay-150 tracking-wide text-center">
                          {item.name}
                        </h3>
                      </div>
                    </div>
