      ...
      <section className="py-32 bg-background text-foreground overflow-hidden">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12 items-center">
            ...
            <Reveal className="space-y-16 w-full max-w-sm mx-auto z-10">
              <div className="flex flex-col items-center text-center">
                <div className="w-10 h-10 flex items-center justify-center text-brand-900 mb-4 rounded-[10px] border border-brand-200 bg-white shadow-sm">
                  <img 
                    src="https://img.icons8.com/?size=100&id=11494&format=png&color=000000" 
                    alt="Color Palette" 
                    className="w-6 h-6 opacity-80"
                  />
                </div>
                <h3 className="text-2xl font-display font-medium mb-3 text-brand-900 leading-tight">Garansi Kesesuaian Warna</h3>
                <p className="text-brand-600/80 text-sm leading-relaxed font-medium">
                  Dengan 378+ pilihan warna, kami menjamin tidak ada perbedaan antar batch. Identitas perusahaan Anda tetap konsisten sempurna.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-display font-medium mb-3 text-brand-900 leading-tight">Pengujian Lapangan Teknis</h3>
                <p className="text-brand-600/80 text-sm leading-relaxed font-medium">
                  Kain kami, termasuk Sumtex Potensha dan Ribstop, telah diuji ketahanannya terhadap abrasi, pilling, dan robekan dalam kondisi yang presisi.
                </p>
              </div>
            </Reveal>

            <Reveal animation="zoom" className="relative w-full flex items-center justify-center p-4 min-h-[400px] z-0">
              <div 
            ...
            <Reveal className="space-y-16 w-full max-w-sm mx-auto z-10">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-display font-medium mb-3 text-brand-900 leading-tight">Manajer Sukses Khusus</h3>
                <p className="text-brand-600/80 text-sm leading-relaxed font-medium">
                  Jalur langsung ke spesialis tekstil untuk memandu Anda dalam pemilihan kain—dari Unione American Drill hingga lini Inma premium kami.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-display font-medium mb-3 text-brand-900 leading-tight">Pemesanan Blok Aman</h3>
                <p className="text-brand-600/80 text-sm leading-relaxed font-medium">
                  Kunci inventaris dan harga bahan baku Anda untuk sepanjang tahun. Pemrosesan berteknologi tinggi menjamin kenyamanan dan perlindungan maksimal.
                </p>
              </div>
            </Reveal>
